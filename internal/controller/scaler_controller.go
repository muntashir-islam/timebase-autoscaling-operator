...
import (
	...
	apiv1alpha1 "github.com/muntashir-islam/k8s-operators/timely-autoscaling-operator/api/v1alpha1"
)
...
//+kubebuilder:rbac:groups=api.muntashirislam.com,resources=scalers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=api.muntashirislam.com,resources=scalers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=api.muntashirislam.com,resources=scalers/finalizers,verbs=update
